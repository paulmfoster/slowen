...
elseif (!empty($_POST['s2'])) {
	header('Location: acctedt.php?id=' . $_POST['id']);
	exit();
}
elseif (!empty($_POST['s3'])) {
	header('Location: acctdel.php?id=' . $_POST['id']);
	exit();
}
...
$focus_field = '';
$page_title = 'Accounts';
$view_file = 'views/acctlist.view.php';
$helpfile = 'views/acctlisth.view.php';
include 'view.php';
