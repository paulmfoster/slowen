<?php if (!defined('DATE_LIB_PHP')) {
	define('DATE_LIB_PHP', TRUE);
	 ...
	 * a date array being passed in from somewhere. A date array looks like
	 * this:
	 *
	 * date = array(
	 * 	'j' => 0, (julian day)
	...
	class date 
	{
		...
		function day_before_quarter($dt)
		{
