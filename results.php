...
if (isset($_GET['vendor'])) {
	$transactions = $sm->get_transactions($_GET['vendor'], 'P');
}
elseif (isset($_GET['category'])) {
	$transactions = $sm->get_transactions($_GET['category'], 'C');
}
else {
...
$view_file = 'views/results.view.php';
$helpfile = 'views/resultsh.view.php';
include 'view.php';
